  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      router.push({
        ...
        params: { email, mode: "register", status: "signupSuccess" },
      });
    } catch (err) {
  ...
  return (
      ...
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        <View style={styles.form}>
          ...
          />
          {errEmail ? (
            <Text style={styles.errMessage}>{errEmail}</Text>
          ) : null}

          <Text style={styles.subtitle}>
            Chúng tôi sẽ gửi mã xác thực qua email để đảm bảo đây là bạn. Vui
